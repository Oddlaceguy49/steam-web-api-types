 ...
 */
export const getNewsForAppRequestSchema = z.object({
    /**
     * @minimum 1
     * @description The AppID of the game for which to retrieve news.
     */
    appid: z.number().min(1).describe("The AppID of the game for which to retrieve news."),
    /**
     * @minimum 0
     ...
     */
    maxlength: z.number().min(0).optional().describe("Maximum length for the content to return. If 0, the full content is returned; if less than the full content, a blurb is generated."),
    /**
     * @format unix-timestamp
     * @description Retrieve posts earlier than this Unix epoch timestamp.
     */
    enddate: z.number().optional().describe("Retrieve posts earlier than this Unix epoch timestamp."),
    /**
     * @minimum 0
     * @description Number of posts to retrieve (default is 20).
     */
    count: z.number().min(0).optional().describe("Number of posts to retrieve (default is 20)."),
    /**
     * @description Comma-separated list of feed names to return news for.
     */
    feeds: z.string().optional().describe("Comma-separated list of feed names to return news for."),
    /**
     * @description Comma-separated list of tags to filter by (e.g., 'patchnodes').
     */
    tags: z.string().optional().describe("Comma-separated list of tags to filter by (e.g., 'patchnodes').")
});
...
export const newsItemSchema = z.object({
     ...
     */
    gid: z.string().regex(/^[0-9]+$/).describe("The unique ID of the news item."),
    /**
     ...
     */
    is_external_url: z.boolean().describe("True if the URL is external, false otherwise."),
    /**
     ...
     */
    date: z.number().describe("The Unix timestamp of when the news item was published."),
    /**
 ...
 */
export const getNewsForAppResponseSchema = z.object({
    appnews: z.object({
        /**
         * @minimum 1
