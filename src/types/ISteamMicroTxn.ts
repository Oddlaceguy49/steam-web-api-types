/***
 * JSDoc type definitions for the Steam Web API's ISteamMicroTxn.
...
/*** Parameters for the ISteamMicroTxn/InitTxn/v2 endpoint.
...
/*** The response from the ISteamMicroTxn/InitTxn/v2 endpoint.
 * @see https://partner.steamgames.com/doc/webapi/ISteamMicroTxn#InitTxn
...
/*** Parameters for the ISteamMicroTxn/FinalizeTxn/v2 endpoint.
...
/*** The response from the ISteamMicroTxn/FinalizeTxn/v2 endpoint.
 * @see https://partner.steamgames.com/doc/webapi/ISteamMicroTxn#FinalizeTxn
...
/*** Parameters for the ISteamMicroTxn/QueryTxn/v2 endpoint.
...
/*** Parameters for the ISteamMicroTxn/GetReport/v3 endpoint.
...
/*** The response from the ISteamMicroTxn/GetReport/v3 endpoint.
 * @see https://partner.steamgames.com/doc/webapi/ISteamMicroTxn#GetReport
...
/*** Parameters for the ISteamMicroTxn/GetUserInfo/v2 endpoint.
...
/*** The response from the ISteamMicroTxn/GetUserInfo/v2 endpoint.
 * @see https://partner.steamgames.com/doc/webapi/ISteamMicroTxn#GetUserInfo
...
/*** Parameters for the ISteamMicroTxn/AdjustAgreement/v1 endpoint.
...
/*** The response from the ISteamMicroTxn/AdjustAgreement/v1 endpoint.
 * @see https://partner.steamgames.com/doc/webapi/ISteamMicroTxn#AdjustAgreement
...
/*** Parameters for the ISteamMicroTxn/GetUserAgreementInfo/v1 endpoint.
...
/*** The response from the ISteamMicroTxn/GetUserAgreementInfo/v1 endpoint.
 * @see https://partner.steamgames.com/doc/webapi/ISteamMicroTxn#GetUserAgreementInfo
...
/*** Parameters for the ISteamMicroTxn/ProcessAgreement/v1 endpoint.
...
/*** The response from the ISteamMicroTxn/ProcessAgreement/v1 endpoint.
 * @see https://partner.steamgames.com/doc/webapi/ISteamMicroTxn#ProcessAgreement
