...
export const GetRecentlyPlayedGamesRequest = z.object({
	...
	count: z
		...
		.min(0)
		.optional()
		.describe("The number of games to return (0 to 100)."),
});
...
export const RecentlyPlayedGame = z.object({
	...
	playtime_2weeks: z
		.number()
		.min(0)
		.describe("Total playtime in the last 2 weeks, in minutes."),
	/**
	 * @minimum 0
	...
	playtime_forever: z
		.number()
		.min(0)
		.describe("Total playtime forever, in minutes."),
	/**
	 * @format url
	 ...
	 */
	has_community_visible_stats: z
		.boolean()
		.describe("True if the game has community visible stats."),
});
